...
import { Heart, MessageCircle, Sparkles, Users, Ban } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <Card className="p-6 border-2 border-primary/10 bg-gradient-to-br from-primary/5 to-transparent">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h3 className="text-lg font-semibold">Character & Tone</h3>
        </div>

        <div className="space-y-6">
          <div>
            <Label htmlFor="persona_archetype" className="mb-2 block">
              Persona Archetype
            </Label>
            <PremiumInput
