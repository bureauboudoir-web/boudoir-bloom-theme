    ...
    <div className="space-y-8">
      ...
      <Card className="p-6 border-2 border-primary/10 bg-gradient-to-br from-primary/5 to-transparent">
        ...
        <div className="space-y-6">
          ...
          <div>
            <Label htmlFor="what_amsterdam_means_to_them" className="mb-2 block">
      ...
      {/* Creative Narrative Card */}
      <Card className="p-6 border-2 border-primary/10">
        <div className="flex items-center gap-2 mb-6">
          <Lightbulb className="h-5 w-5 text-primary" />
          <h3 className="text-lg font-semibold">Creative Narrative</h3>
        </div>

        <div className="space-y-6">
          <div>
            <Label htmlFor="how_they_see_themselves_in_RLD" className="mb-2 block">
