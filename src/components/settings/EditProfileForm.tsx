...
export const EditProfileForm = ({ userId, onboardingData, onUpdate }: EditProfileFormProps) => {
  ...
  return (
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>Update your personal information from onboarding steps 1-2</CardDescription>
          </div>
          {!isEditing ? (
      ...
      <CardContent>
        <Accordion type="multiple" defaultValue={isEditing ? ["personal", "emergency", "physical"] : []} className="w-full">
          ...
          <AccordionItem value="emergency">
            <AccordionTrigger className="text-lg font-semibold">Emergency Contact</AccordionTrigger>
            <AccordionContent className="pt-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
          ...
          <AccordionItem value="physical">
            <AccordionTrigger className="text-lg font-semibold">Physical Description</AccordionTrigger>
            <AccordionContent className="pt-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
